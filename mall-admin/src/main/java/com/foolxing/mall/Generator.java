...
public class Generator {
    ...
    public static void main(String[] args) {
        // 1.数据源配置
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/mall","root","asdf").build();
        ...
        // 作者
        globalConfigBuilder.author("FoolXing");
        // 结束时是否打开文件夹
        ...
        packageConfigBuilder.parent("com.foolxing.mall");           //项目包名
